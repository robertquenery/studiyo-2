          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              {discussions.map((discussion) => (
                <div key={discussion.id} className="p-4 border border-gray-100 rounded-lg hover:border-gray-200 transition-colors">
                  ...
                  <p className="text-sm text-gray-600 mb-3">{discussion.course}</p>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-2">
              <button className="w-full p-3 text-left rounded-lg hover:bg-gray-50 flex items-center gap-3">
