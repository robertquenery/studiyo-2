  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Access course materials and study tools</p>
      </div>
            ...
            <div className="space-y-6">
              {courseResources.map((course, index) => (
                <div key={index} className="border-b border-gray-200 pb-6 last:border-0 last:pb-0">
                  <h3 className="font-medium text-gray-900 mb-4">{course.course}</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="space-y-6">
              {digitalLibrary.map((section, index) => (
                <div key={index}>
                  <h3 className="text-sm font-medium text-gray-900 mb-3">{section.category}</h3>
                  <div className="space-y-3">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              {studyTools.map((tool, index) => (
                <div key={index} className="p-4 bg-gray-50 rounded-lg flex items-start gap-4">
