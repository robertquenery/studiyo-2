                  ...
                  {currentGrades.map((course, index) => (
                    <tr key={index}>
                      ...
                      <td className="px-4 py-3 border-b border-gray-200">
                        ...
                        <div className="text-xs text-gray-600 mt-1">{course.percentage}%</div>
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 rounded-lg">
                <div className="text-3xl font-bold text-blue-700">3.70</div>
                <div className="text-sm text-blue-600">Current Semester GPA</div>
              </div>
              <div className="p-4 bg-green-50 rounded-lg">
                <div className="text-3xl font-bold text-green-700">3.70</div>
                <div className="text-sm text-green-600">Cumulative GPA</div>
              </div>
            </div>
          </div>
              ...
              {gradeHistory.map((semester, index) => (
                <div key={index} className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    <h3 className="font-medium text-gray-900">{semester.semester}</h3>
                    <span className="text-sm font-medium text-blue-600">GPA: {semester.gpa}</span>
                  </div>
